...
{
    public class DealerDeliveryStickerConnector
    {
        private readonly IDealerDeliveryService _dealerDeliveryService;
          private readonly string OEMID;
        public DealerDeliveryStickerConnector(IDealerDeliveryService dealerDeliveryService ,IOptionsSnapshot<DynamicDataDto> dynamicDto)
        {
            _dealerDeliveryService = dealerDeliveryService ?? throw new ArgumentNullException(nameof(dealerDeliveryService));
            OEMID = dynamicDto.Value.StickerOemForRates;
