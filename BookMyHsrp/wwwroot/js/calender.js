            ...
            function calendar(calendarOptions) {
                ...
                function isInRange(date, allday, validator) {
                    ...
                    if (validator && typeof validator === 'function') {
                        // Call your function to get the list of disabled dates
                        var disabledDates = GetHolidays();

                        // Convert the disabled dates to Moment objects for comparison
                        var disabledMoments = disabledDates.map(function (dateString) {
                            return momentum.moment(dateString, 'YYYY-MM-DD');
                        });

                        // Check if the current date is in the list of disabled dates
                        if (disabledMoments.some(function (disabledDate) {
                            return date.isSame(disabledDate, 'day');
                        })) {
                            return false; // Date is disabled
                        }
                    }
