...
namespace BookMyHsrp.Libraries.HomeDeliverySticker.Services
{
    public  class HomeDeliveryStickerService :IHomeDeliveryStickerService
    {
        ...
        public HomeDeliveryStickerService(IOptionsSnapshot<ConnectionString> connectionStringOptions, FetchDataAndCache fetchDataAndCache, IOptionsSnapshot<DynamicDataDto> dynamicData)
        {
