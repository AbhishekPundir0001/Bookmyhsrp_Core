...
namespace BookMyHsrp.Libraries.DealerDelivery.Models
{
    public class DealerDeliveryModel
    {
        public class SetSessionDealer
        {
            public string Status { get; set; }
            public string Message { get; set; }
           public DealerData data { get; set; }
           public List<DealerAppointmentData> dealerAppointment { get; set; }
        }
        ...
        public class DealerAppointmentData
        {
        ...
        public class DealerAppointmentResponseLatestDate
        {
            public string status { get; set; }
            public string message { get; set; }
            public string data { get; set; }
        }
        public class DealerAppointmentRequestData
        {
