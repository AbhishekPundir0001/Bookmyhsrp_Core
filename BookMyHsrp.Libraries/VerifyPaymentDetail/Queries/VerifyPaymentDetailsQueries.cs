...
namespace BookMyHsrp.Libraries.VerifyPaymentDetail.Queries
{
    public class VerifyPaymentDetailsQueries
    {
        ...
        public static readonly string CheckOemRateQuery = "exec CheckOrdersRates @OemId,@OrderType,@VehicleClass,@VehicleType,@VehiclecategoryId,@FuelType,@DeliveryPoint,@StateId ,@StateName";
