...
namespace BookMyHsrp.Libraries.HsrpWithColorSticker.Models
{
    public class RootDtoSticker
    {
        ...
        public string ShippingAddress1 { get; set; } = "";
            ...
            public PaymentConfirmationResponseSticker paymentConfirmationResponse { get; set; }
            public bool IsExpressCheckout { get; set; } = false;
        
    }
    public class PaymentConfirmationResponseSticker
    {
        public string Status { get; set; }
        public string Message { get; set; }
        public PaymentConfirmationResponseDataSticker data;
    }
    public class VerifyDetailPaymentResponseSticker
    {
        public string Status { get; set; }
        public string Message { get; set; }
    ...
    public class VerifyDetailPaymentDataSticker
    {
