...
{
    public class CustomerInfoModelSticker
    {
    ...
    public class CustomerInformationResponseSticker
    {
    ...
    public class CustomerInformationDataSticker
    {
    ...
    public class SetCustomerDataSticker
    {
        public string NonHomoVehicleType { get; set; }
        public string Message { get; set; }
        public string VehicleType { get; set; }
