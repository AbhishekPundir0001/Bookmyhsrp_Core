...
{
    public class ReplacementHsrpColorStickerModel
    {
        public class ReplacementVahanDetailsDto
        {
        ...
        public class ReplacementVehicleDetails
        {
            ...
            public ReplacementVehicleValidation data;
        }
        ...
        public class ReplacementResponseSticker
        {
            public string Message { get; set; }

        }

        public class ReplacementGetSessionBookingDetails
        {
        ...
        public class ReplacementVehicleValidation
        {
            public string fuel { get; set; }
            public string StateIdBackup { get; set; }
            public string maker { get; set; }
