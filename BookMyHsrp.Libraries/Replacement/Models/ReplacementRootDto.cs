...
{
    public class ReplacementRootDto
    {
        ...
        public string ShippingAddress1 { get; set; } = "";
            ...
            public ReplacementVerifyDetailPaymentResponse paymentValidateResponse { get; set; }
            ...
            public ReplacementPaymentConfirmationResponse paymentConfirmationResponse { get; set; }
            public bool IsExpressCheckout { get; set; } = false;
        
    }
    public class ReplacementPaymentConfirmationResponse
    {
        public string Status { get; set; }
        public string Message { get; set; }
        public PaymentConfirmationResponseData data;
    }
    public class ReplacementVerifyDetailPaymentResponse
    {
        public string Status { get; set; }
        public string Message { get; set; }
    ...
    public class ReplacementPaymentConfirmationResponseData
    {
    ...
    public class ReplacementVerifyDetailPaymentData
    {
